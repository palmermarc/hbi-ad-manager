...
class HBI_Ad_Manager_Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in HBI_Ad_Manager_Admin_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The HBI_Ad_Manager_Admin_Loader will then create the relationship
	...
	public function enqueue_scripts() {
		 ...
		 * class.
		 */
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/hbi-ad-manager-admin.js', array( 'jquery' ), $this->version, false );
	}
    ...
    function hbi_ad_manager_save_meta_boxes( $post_id ) {
        ...
        $tag_id = $_POST['tag_id'];
        $admap_to_use = absint( $_POST['admap_to_use'] );
        ...
        $new_conditionals = array();
        $unsafe_conditionals = ( $_POST['ad_unit_conditionals'] ) ?  $_POST['ad_unit_conditionals'] : array();
