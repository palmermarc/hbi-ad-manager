...
?>
<div <?php post_class('pp-content-post pp-content-carousel-post pp-grid-' . $settings->post_grid_style_select); ?> itemscope="itemscope" itemtype="<?php DFPContentGridModule::schema_itemtype(); ?>">
	...
	<?php DFPContentGridModule::schema_meta(); ?>
