...
?>
<div <?php post_class('pp-content-post pp-content-grid-post '. 'pp-grid-' . $settings->post_grid_style_select); ?> itemscope itemtype="<?php DFPContentGridModule::schema_itemtype(); ?>">
